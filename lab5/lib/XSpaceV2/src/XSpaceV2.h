...
class XSpaceV2Board{
    ...
    public:
        ...
        void init_encoder(double resolution);
        void init_DRV8837(int freq);
        void init_BTS7960(int R_EN, int L_EN, int RPWM, int LPWM, int freq, double vm);
        void DRV8837_Sleep();
        void DRV8837_Wake();
        void BTS7960_Sleep();
        void BTS7960_Wake();
        void DRV8837_Voltage(double vp);
        void BTS7960_Voltage(double vp);

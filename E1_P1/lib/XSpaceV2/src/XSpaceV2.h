...
class XSpaceV2Board{
    ...
    public:
        ...
        /// @brief Obtiene el valor del flujo medido
        /// @return Flujo escalado de 0 a 100
        double flujo();

        /// @brief Asigna PWM al canal correspondiente. 
        /// @param pc Porcentaje de apertura de la valvula, de 0 a 100.
        void Valvula(double pc);
